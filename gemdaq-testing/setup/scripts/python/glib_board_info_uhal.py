...
print "-> GLIB DAQ GTX NOT_IN_TABLE error counter :0x%08x"%(readRegister(glib,"GLIB.DAQ.EXT_STATUS.NOTINTABLE_ERR"))
print "-> GLIB DAQ GTX dispersion error counter :0x%08x"%(  readRegister(glib,"GLIB.DAQ.EXT_STATUS.DISPER_ERR"))
print "-> GLIB DAQ L1A ID :0x%08x"%(                        readRegister(glib,"GLIB.DAQ.EXT_STATUS.L1AID"))
print "-> GLIB DAQ sent events cnt :0x%08x"%(               readRegister(glib,"GLIB.DAQ.EXT_STATUS.EVT_SENT"))

print "-> GLIB DAQ GTX0 corrupted VFAT block counter :0x%08x"%(readRegister(glib,"GLIB.DAQ.GTX0.COUNTERS.CORRUPT_VFAT_BLK_CNT"))
print "-> GLIB DAQ GTX0 evn :0x%08x"%(                         readRegister(glib,"GLIB.DAQ.GTX0.COUNTERS.EVN"))
