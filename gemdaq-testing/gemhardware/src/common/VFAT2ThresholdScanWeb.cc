...
void gem::hw::vfat::VFAT2ThresholdScan::VFAT2ThresholdScanWeb::saveCurrentParametersAsXML( ) {
  
}

void gem::hw::vfat::VFAT2ThresholdScan::VFAT2ThresholdScanWeb::setParametersByXML( ) {
