...
std::string gem::utils::uint32ToGroupedHex(uint32_t const& val1, uint32_t const& val2) {
  ...
  res << std::setfill('0') << std::setw(2) << std::hex
      <<static_cast<uint32_t>((val1 & (0x0000ff00)) / 256)      << std::dec << ":";
  res << std::setfill('0') << std::setw(2) << std::hex
      <<static_cast<uint32_t>((val1 & (0x000000ff)))            << std::dec << ":";
  res << std::setfill('0') << std::setw(2) << std::hex
      <<static_cast<uint32_t>((val2 & (0xff000000)) / 16777216) << std::dec << ":";
  res << std::setfill('0') << std::setw(2) << std::hex
      <<static_cast<uint32_t>((val2 & (0x00ff0000)) / 65536)    << std::dec << ":";
  res << std::setfill('0') << std::setw(2) << std::hex
      <<static_cast<uint32_t>((val2 & (0x0000ff00)) / 256)      << std::dec << ":";
  res << std::setfill('0') << std::setw(2) << std::hex
      <<static_cast<uint32_t>((val2 & (0x000000ff)))            << std::dec;
  return res.str();
}
