                   ...
                   p_gemApp->getApplicationContext())
{
  ...
  p_gemfsm->addStateTransition(STATE_INITIAL, STATE_HALTED, "Initialize", p_gemApp,
...
//throw (toolbox::fsm::exception::Exception)
{
  ...
  DEBUG(toolbox::toString("GEMFSM::changeState() received command '%s'.", commandName.c_str()));
  ...
  try {
    ...
    /*xoap::MessageReference reply = 
      ...
      return reply;*/
    return gem::utils::soap::GEMSOAPToolBox::makeFSMSOAPReply(commandName, newStateName);
