...
class AMCmanager:
  ...
  def getStatus(self, verbosity):
    ...
    self.status += '<tr><th>MAX DAV TIMER</th><td>0x%08X</td><td>0x%08X</td></tr>' % (readRegister(self.glib,"GLIB.DAQ.GTX0.COUNTERS.MAX_DAV_TIMER"),readRegister(self.glib,"GLIB.DAQ.GTX1.DAV_STATS.MAX_DAV_TIMER"))
    self.status += '<tr><th>LAST DAV TIMER</th><td>0x%08X</td><td>0x%08X</td></tr>' % (readRegister(self.glib,"GLIB.DAQ.GTX0.COUNTERS.MAX_DAV_TIMER"),readRegister(self.glib,"GLIB.DAQ.GTX1.DAV_STATS.MAX_DAV_TIMER"))
