#ifndef gem_dqm_ROOT_TTree
#define gem_dqm_ROOT_TTree
...
namespace dqm {
    ...
    class GEBdata {
        ...
        public:
            ...
            void setTrailer(const uint64_t &OHcrc_, const uint64_t &OHwCount_, const uint64_t &ChamStatus_){
                OHcrc = OHcrc_; OHwCount = OHwCount_; ChamStatus = ChamStatus_;
            }
